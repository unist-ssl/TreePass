...
typedef struct core_stats {
   ...
   platform_histo_handle lookup_latency_histo;
...
struct core_handle {
   ...
   // Memtable CI tracking: CI = (now - root_entry_time) / flush_count
   uint32    root_ci_flush_count; // incorporations since root page was born
