...
typedef struct trunk_stats {
   ...
   // Compaction interval statistics
   uint64 compaction_interval_sum_ns[TRUNK_MAX_HEIGHT];
   uint64 compaction_interval_count[TRUNK_MAX_HEIGHT];
   uint64 compaction_interval_min_ns[TRUNK_MAX_HEIGHT];
   uint64 compaction_interval_max_ns[TRUNK_MAX_HEIGHT];
